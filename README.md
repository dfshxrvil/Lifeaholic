...
2. Run the SQL files in `supabase/migrations` in numeric order. Existing projects should apply all remaining migrations through `008_finance_core.sql`. See [personal finance setup and verification](docs/personal-finance-fix.md) and [finance core architecture](docs/finance-core.md).
